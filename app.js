...
const SPREAD_DEFS = {
    three: {
        ...
        desc: '过去-现在-未来，最基础的线性时间之镜'
    },
    heartVoice: {
        label: '心之声牌阵', count: 8,
        slots: ['感情现状', '不久的将来', '他/她对你的看法(内)', '他/她对你的看法(外)', '对方的状态', '他/她希望的结果', '自己的状态', '建议'],
        meanings: ['当下的核心状态', '即将到来的进展', '他/她内心的潜意识', '他/她外在的表现', '对方现在的生活状态', '对方期望的走向', '你自己的内心状态', '接下来的行动指南'],
        desc: '适用于两个人的感情走向，探索双方视角与内心'
    },
    relationship: {
        label: '关系牌阵', count: 6,
        slots: ['能量流动', '你对感情的态度', '对方对感情的态度', '这段关系的本质', '未来面临的问题', '建议'],
        meanings: ['你们之间的情感交互', '你当下的心态', '对方当下的心态', '关系的核心议题', '未来的阻碍', '破局的指引'],
        desc: '探索感情全貌，适合总览一段关系'
    },
    choice: {
        label: '二选一选择牌阵', count: 5,
        slots: ['你当下的情况', '选A的发展情况', '选A的结果', '选B的发展情况', '选B的结果'],
        meanings: ['现状与你的状态', 'A路线的进程', 'A路线的终点', 'B路线的进程', 'B路线的终点'],
        desc: '你有两个或三个选择，需要看如何做抉择'
    },
    breakupReunion: {
        label: '分手复合X牌阵', count: 9,
        slots: ['过去基础', '你的现状', '对方现状', '你的真实想法', '对方的真实想法', '分手的具体原因', '帮助复合的建议', '你不知道的事情', '未来两人会如何'],
        meanings: ['关系的基础和起因', '你现在的处境', '对方现在的处境', '你内心的真实诉求', '对方内心的真实想法', '导致分离的根本原因', '促进复合的行动', '被隐瞒的真相', '未来的发展趋势'],
        desc: '分手后的感情看复合，基于当下双方状态探索可能性'
    },
    loversVenus: {
        label: '恋人维纳斯', count: 8,
        slots: ['你的表现', '对方表现', '感情的过去', '感情的现状', '因果(障碍)', '你的内心', '对方内心', '感情的未来'],
        meanings: ['你展现出的态度', '对方展现出的态度', '前期的基础', '当下的状态', '遇到的阻碍', '你对关系的期许', '对方对关系的期许', '最终的发展方向'],
        desc: '长期恋爱关系/婚姻，重点挖掘双方表现与潜在想法'
    },
    loversCross: {
        label: '恋人十字牌阵', count: 5,
        slots: ['你现在的心境', '对方对这段关系的看法', '你们过去的关系情况', '你们现在的关系情况', '你们关系的未来走向'],
        meanings: ['你当前的内心状态', '对方视角下的关系', '彼此的历史根源', '当下的相处模式', '未来的发展轨迹'],
        desc: '针对两人的爱情进行快速交叉占卜'
    },
    celtic: {
